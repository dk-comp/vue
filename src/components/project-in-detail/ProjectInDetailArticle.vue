<template>
  <div class="project-in-detail-article">
    <div class="contents">
      <div class="c-header">
        <h6>Содержание проекта:</h6>
        <a href="#" class="button">
          <span>Скачать документацию в pdf</span>
        </a>
      </div>
      <div class="c-items">
        <div class="c-item">
          <a href="#">Вводное слово</a>
        </div>
        <div class="c-item">
          <a href="#">Название первого раздела проекта</a>
          <ul>
            <li><a href="#">Подраздел первого раздела проекта</a></li>
            <li><a href="#">Второй подраздел первого раздела проекта</a></li>
            <li><a href="#">Третий подраздел первого раздела проекта</a></li>
          </ul>
        </div>
        <div class="c-item">
          <a href="#">Технические характеристики проекта</a>
        </div>
        <div class="c-item">
          <a href="#">Название второго раздела проекта</a>
          <ul>
            <li><a href="#">Подраздел второго раздела проекта</a></li>
            <li><a href="#">Второй подраздел второго раздела проекта</a></li>
            <li><a href="#">Третий подраздел второго раздела проекта</a></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    .c-items
      ...
      .c-item
        ...
        li
          ...
          &::before
            content: url("data:image/png;base64,")
            margin-right: 8px
